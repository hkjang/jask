...
import { Loader2, Check, X, AlertTriangle, HelpCircle } from 'lucide-react';
      ...
      <div className="space-y-6 p-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">시스템이 생성한 자가 개선 후보를 검토하고 승인합니다.</p>
          </div>
          <Dialog>
            ...
            <DialogContent className="max-w-2xl">
              ...
              <div className="space-y-4 overflow-y-auto max-h-[60vh]">
                ...
                <div className="space-y-2">
                   <h3 className="font-semibold text-lg">검토 및 승인 절차</h3>
                   <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1">
                      <li><strong>관련 질문 (근거 자료):</strong> 해당 개선안이 제안되게 된 원인이 되는 실제 사용자 질문들을 확인하세요.</li>
                      <li><strong>제안된 변경 사항:</strong> AI가 예시로 제시한 수정된 메타데이터나 프롬프트를 검토하세요.</li>
                      <li><strong>승인(Approve):</strong> 개선안이 타당하다고 판단되면 승인합니다. 시스템에 즉시 반영됩니다.</li>
                      <li><strong>거부(Reject):</strong> 잘못된 제안이라면 거부하여 폐기합니다.</li>
                   </ul>
                </div>
              </div>
            </DialogContent>
